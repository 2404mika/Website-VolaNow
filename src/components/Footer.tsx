    ...
    <footer className="py-8 md:py-10 px-4 sm:px-6 lg:px-8 border-t border-gray-200 bg-[#F2F2F4]">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-6">
          <a href="/conditions" className="text-gray-400 text-sm md:text-base hover:text-[#B0FC51] transition-colors duration-300">
            Conditions d&apos;utilisation
          </a>
          <a href="/privacy" className="text-gray-400 text-sm md:text-base hover:text-[#B0FC51] transition-colors duration-300">
