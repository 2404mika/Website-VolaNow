  ...
  return (
    <section id="home" className="mx-3 pt-24">
      <div className="w-full">
        <div className="bg-[#1a1a1a] rounded-3xl md:rounded-[4.5rem] overflow-hidden min-h-[70vh] md:min-h-[85vh] flex flex-col lg:flex-row items-center justify-center md:p-5 lg:px-16">
