  ...
  return (
    <section id="home" className="mx-3 pt-24 pb-8">
      <div className="w-full">
        <div className="bg-[#1a1a1a] rounded-3xl md:rounded-[4.5rem] overflow-hidden min-h-[70vh] md:min-h-[85vh] flex flex-col lg:flex-row items-center justify-center p-6 md:p-12 lg:px-16">
          ...
          <div className="z-10 w-full h-full flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
            <div className="order-2 lg:order-1 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
              ...
              <div className={`mt-6 md:mt-10 flex items-center gap-4 md:gap-6 transition-all duration-1000 delay-300 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
                <button className="group bg-[#B0FC51] text-[#181818] px-6 md:px-8 py-3 md:py-4 rounded-full font-bold flex items-center gap-2 hover:scale-105 transition-transform text-sm md:text-base">
                  Get the App
                  <span>→</span>
                </button>
